...
class SaleForm(forms.ModelForm):
    class Meta:
        model = Sale
        fields = ['sale_to', 'quantity', 'measurement_unit', 'product', 'category', 'serial_no', 'box_type', 'date', 'verified_by']
...
class PurchaseForm(forms.ModelForm):
    class Meta:
        model = Purchase
        fields = ['purchased_from', 'quantity', 'measurement_unit', 'product', 'category', 'serial_no', 'box_type', 'date', 'verified_by']
